...
class Cultivaor extends Car {
    void run() {
        System.out.println("경운기 지나가요 지나가요~ 덜컹덜컹");
    }
}
...
public class Java100_oop_Polymorphism6 {
    public static void main(String[] args) {
        ...
        // cars = new Car[] { new Ambulance(), new Cultivaor(), new SportsCar() }; //
        // cars 배열 초기화

        // [2]: 1번 방법 말고 --> 자식 클래스로 객체 생성 --> 타입은 부모 타입으로 --> 이렇게 생성된 객체들로 바로 배열 초기화
        // --> 다형성 덕분
        Car[] cars = { new Ambulance(), new Cultivaor(), new SportsCar() };
