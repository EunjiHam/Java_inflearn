...
class Villain extends Person{
    ...
    Villain(String name, int age, int height, int weight, String unique_key, int weapon, double power) {
        ...
        this.unigue_key = unique_key;
        this.weapon = weapon;
        this.power = power;
    }

    // Method
    public String getUnique_key() { return this.unigue_key; }
    public void setUnique_key(String unique_key) { this.unigue_key = unique_key; }
