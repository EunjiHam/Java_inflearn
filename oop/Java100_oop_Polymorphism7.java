// 다형성을 사용하면 배열이나 매개변수 활용에 좋다는데 자세히 코드로 설명해보시오.
...
public class Java100_oop_Polymorphism7 {
    public static void main(String args[]) {
        ...
        // Sytsem.out.println() 메서드의 경우 어떤 타입, 객체를 매게변수로 받더라도 에러없이 해당 객체의 값을 출력
        // 그것이 가능한 이유 --> 바로 다형성을 활용하고 있기 때문이다.
        // 실제 메서드의 API를 보면 --> public void println(Object x)로 되어있기에 어떤 객체 타입이 전달되더라도 에러
        // 없이 출력이 되는 것이다.
