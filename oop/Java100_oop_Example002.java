...
// [1]: 클래스는 왜 나왔을까?
// 클래스 없이도 객체의 특징(속성)들은 변수로 정의할 수 있을 것이고, 동작은 함수로 정의를 할 수 있을 것이다.
// 그러나 프로그램의 규모가 커지고 여러 사람이 협업을 하는 과정에서 좀 더 체계적이고 분업하된 시스템으로 개발하고 확장해나갈 필요성이 있다.
// 그런 일련의 과정에서 OOP(객체 지향 프로그래밍)가 만들어지고 발전해왔다.
// 거의 모든 프로그래밍 언어에서 OOP 문접을 지원하고 있고 하나의 언어로 OOP 문법을 공부하면 다른 언어에서도 거의 동일하다.
...
public class Java100_oop_Example002{
