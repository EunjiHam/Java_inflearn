...
// 굉장히 많이 나오는 단골 패턴이므로 잘 숙지하고 여러번 타이핑을 하면서 반복 연습을 해야만 한다.
...
public class Java100_license_CosPattern1 {
    public static void main(String[] args) {
        ...
        // 1 --> 빈 정수형 배열(ar)을 하나 만들어 놓고 초깃값은 모두 0으로 셋팅한다.
        // 2 --> target 배열 내 숫자가 빈 배열(ar)의 인덱스로 적용해서 해당 인덱스의 ar 배열 요소의 값을 1씩 증가시킨다.
        // 3 --> 이때, 빈 배열(ar)의 요소 갯수는 target 배열 내 숫자들의 종류 만큼 지정한다.
